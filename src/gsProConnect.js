...
class GsProConnect {
        ...
        this.socket.on('error', (e) => {
            if (e.code === 'ECONNREFUSED') {
                ...
                this.ipcPort.postMessage({
                    type: 'GSProMessage',
                    message:
                        'Error with GSPro connection.  Trying to reconnect...',
                });
                setTimeout(() => {
    ...
    launchBall(ballData, clubData, ballModifierPercentage) {
        const APIData = {
            ...
            BallData: {
                Speed: ballData.ballSpeed + (ballData.ballSpeed * ballModifierPercentage / 100),
